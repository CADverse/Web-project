        ...
        <div className="text-center">
          ...
          >
            <button
              ...
              className="inline-flex items-center gap-3 bg-blue-600 dark:bg-blue-500 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-all duration-200 sketch-shadow dark:sketch-shadow-dark group hover:shadow-xl transform hover:-translate-y-1"
            >
              Get Started
