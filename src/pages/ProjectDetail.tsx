            ...
            <div className="lg:col-span-1">
              ...
              >
                  ...
                  <div className="space-y-3">
                    {project.liveDemo && (
                      <a
                        ...
                        className="flex items-center gap-3 bg-blue-600 dark:bg-blue-500 text-white px-4 py-3 rounded-lg font-medium hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors group"
                      >
                    ...
                    {project.sourceCode && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-3 bg-gray-800 dark:bg-gray-700 text-white px-4 py-3 rounded-lg font-medium hover:bg-gray-900 dark:hover:bg-gray-600 transition-colors group"
                      >
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-800">
                  ...
                  <blockquote className="text-gray-700 dark:text-gray-300 font-mono italic mb-6 text-sm leading-relaxed">
